...
function Editor({onClose,onSubmit,onSubmitPrivate,th,userInst}){const t=th||TH.classic;const isStudio=t===TH.studio;
  ...
  const cSel=(val,opts,onChange,w)=>React.createElement("div",{style:{position:"relative",width:w||"100%"}},React.createElement("select",{value:val,onChange:e=>onChange(e.target.value),style:{...ip,appearance:"none",cursor:"pointer",width:"100%",paddingRight:32}},opts.map(o=>React.createElement("option",{key:o,value:o,style:{background:t.card}},o))),React.createElement("span",{style:{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",pointerEvents:"none",fontSize:10,color:t.muted}},"\u25BE"));
  ...
  return React.createElement("div",{style:{position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:1000,background:t.bg,display:"flex",flexDirection:"column"}},
        ...
        React.createElement("div",{style:{display:edStep===0?"flex":"none",flexDirection:"column",gap:14}},
          React.createElement("div",{style:{background:t.card,borderRadius:14,padding:"16px",border:"1px solid "+(artistOk?t.accentBorder:t.border),transition:"border-color 0.3s"}},
            React.createElement("div",{style:{display:"flex",flexDirection:"column",gap:12}},
              ...
              React.createElement("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10}},
                React.createElement("div",null,React.createElement("label",{style:lb},"FEEL"),React.createElement("div",{style:{position:"relative"}},React.createElement("select",{value:feel,onChange:e=>setFeel(e.target.value),style:{...ip,appearance:"none",cursor:"pointer",paddingRight:32}},React.createElement("option",{value:"straight",style:{background:t.card}},"Straight"),React.createElement("option",{value:"swing",style:{background:t.card}},"Swing"),React.createElement("option",{value:"hard-swing",style:{background:t.card}},"Hard Swing")),React.createElement("span",{style:{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",pointerEvents:"none",fontSize:10,color:t.muted}},"\u25BE"))),
                React.createElement("div",null,React.createElement("label",{style:lb},"INSTRUMENT"),React.createElement("div",{style:{position:"relative"}},React.createElement("select",{style:{...ip,appearance:"none",cursor:"pointer",paddingRight:32},value:inst,onChange:e=>sI(e.target.value)},INST_LIST.filter(i=>i!=="All").map(i=>React.createElement("option",{key:i,value:i,style:{background:t.card}},i))),React.createElement("span",{style:{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",pointerEvents:"none",fontSize:10,color:t.muted}},"\u25BE"))),
                React.createElement("div",null,React.createElement("label",{style:lb},"CATEGORY"),React.createElement("div",{style:{position:"relative"}},React.createElement("select",{style:{...ip,appearance:"none",cursor:"pointer",paddingRight:32},value:cat,onChange:e=>sC(e.target.value)},CAT_LIST.filter(c=>c!=="All").map(c=>React.createElement("option",{key:c,value:c,style:{background:t.card}},c))),React.createElement("span",{style:{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",pointerEvents:"none",fontSize:10,color:t.muted}},"\u25BE")))),
              React.createElement("div",null,
    ...
    // Chord hint dialog — backdrop + centered dialog as siblings
    showChordHint&&!Object.keys(chordsRef.current||{}).length&&React.createElement(React.Fragment,null,
      React.createElement("div",{onClick:function(){setShowChordHint(false);},style:{position:"absolute",top:0,left:0,right:0,bottom:0,zIndex:1100,background:"rgba(0,0,0,0.5)"}}),
      React.createElement("div",{onClick:function(e){e.stopPropagation();},style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",zIndex:1101,background:t.card,borderRadius:16,padding:"24px 20px",maxWidth:320,width:"calc(100% - 40px)",border:"1px solid "+(isStudio?t.accent+"30":t.border),boxShadow:"0 12px 40px rgba(0,0,0,"+(isStudio?"0.6":"0.2")+"), 0 0 24px "+(isStudio?"rgba(34,216,158,0.15)":"rgba(99,102,241,0.1)")}},
