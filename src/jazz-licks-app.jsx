...
function Notation({abc,compact,abRange,curNoteRef,curProgressRef,focus,th,onNoteClick,selNoteIdx,onDeselect,theoryMode,theoryAnalysis,onReady,soundAbc,bassClef}){
  ...
  useEffect(()=>{if(!curNoteRef&&!curProgressRef)return;
    ...
    var computeRatio=function(){
      ...
      var sr=svg.getBoundingClientRect();var cr=ref.current.getBoundingClientRect();
  ...
  const isStudio=t===TH.studio;
  return React.createElement("div",{ref:ref,style:{position:"relative",borderRadius:focus?0:isStudio?12:10,background:focus?"transparent":compact?"transparent":t.noteBg,padding:focus?"0":compact?"6px 10px":(isStudio?"14px 16px":"12px 14px"),border:focus?"none":compact?"none":"1px solid "+(isStudio?t.border:t.borderSub),overflow:compact?"hidden":"visible"}},
