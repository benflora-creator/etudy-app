...
const FLAT_ABC=[{n:“C”,a:””},{n:“D”,a:”*”},{n:“D”,a:””},{n:“E”,a:”*”},{n:“E”,a:””},{n:“F”,a:””},{n:“G”,a:”*”},{n:“G”,a:””},{n:“A”,a:”*”},{n:“A”,a:””},{n:“B”,a:”_”},{n:“B”,a:””}];
...
function rN(s,i,ks,barAcc){let a=null;while(i<s.length&&(s[i]===”^”||s[i]===”*”||s[i]===”=”)){if(s[i]===”^”)a=(a===null?1:a+1);else if(s[i]===”*”)a=(a===null?-1:a-1);else a=0;i++;}if(i>=s.length)return null;const c=s[i];if(!((c>=“A”&&c<=“G”)||(c>=“a”&&c<=“g”)))return null;const lo=c>=“a”,nl=c.toUpperCase();let o=lo?5:4;i++;while(i<s.length&&(s[i]===”’”||s[i]===”,”)){if(s[i]===”’”)o++;else o–;i++;}let sa=0;var explicitAcc=a!==null;if(a!==null){sa=a;}else{var bk=nl+o;if(barAcc&&barAcc[bk]!==undefined){sa=barAcc[bk];}else{const ka=ks[nl.toLowerCase()];if(ka)sa=ka;}}let tn=nl;if(sa>0)tn+=”#”;else if(sa<0)tn+=“b”;tn+=o;return{t:tn,n:i,explicit:explicitAcc,letter:nl,oct:o,acc:sa};}
...
var ref=useRef(false);var *=useState(0);var force=*[1];
...
var bRoot=chordBassNote(c.name);var bq=c.name.substring(c.name.match(/^[A-G]?/)?.[0]?.length||1).toLowerCase();var fifthSt=(N2M[c.name[0].toUpperCase()]||0)+(c.name[1]===”#”?1:c.name[1]===“b”?-1:0)+7;var bFifth=[“C”,“C#”,“D”,“Eb”,“E”,“F”,“F#”,“G”,“Ab”,“A”,“Bb”,“B”][((fifthSt%12)+12)%12]+“2”;
